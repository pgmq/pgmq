...
-- read_fifo
-- reads messages from a queue while respecting FIFO ordering within message groups
...
-- read_fifo_with_poll
-- reads messages from a queue while respecting FIFO ordering within message groups, with polling support
